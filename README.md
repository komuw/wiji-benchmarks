...
- It queues about 10K network IO bound task. Each of these tasks makes a newtwork request to a backend with a latency that varies between 200 and 600 milliseconds. The backend in question is `https://httpbin.org/delay/{latency}`    
